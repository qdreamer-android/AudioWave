...
public class WaveAdapter extends BaseQuickAdapter<WaveItemModel, BaseViewHolder> {
    ...
    public WaveAdapter(int screenWidth, int waveCount, int waveColor) {
...
//        LineChart chartWave = (LineChart) helper.itemView;
    ...
    private boolean reSetScale(float value) {
